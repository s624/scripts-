...
xsetwacom set "Wacom Intuos BT M Pen stylus" MapToOutput HDMI-1     
xsetwacom set "Wacom Intuos BT M Pen eraser" MapToOutput HDMI-1   
xsetwacom set "Wacom Intuos BT M Pen cursor" MapToOutput HDMI-1     
xsetwacom set "Wacom Intuos BT M Pad pad"    MapToOutput HDMI-1
